...
class PBRInwardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_pbrinward, container, false)
        ...
        val cursor = db.get_inward(data.toString())
        if (cursor.moveToFirst())
        {
            val lrnotxt = cursor.getString(cursor.getColumnIndex(DatabaseColumns.INWARD_LR_NUMBER))
            val invtxt = cursor.getString(cursor.getColumnIndex(DatabaseColumns.INWARD_INVOICE_NUMBER))
